-- Description -----------------------------------------------------------------------------
--
-- Indentation for Julia files (*.jl). This script runs after the runtime indent script,
-- which would otherwise override 'indentexpr'.
--
-- -----------------------------------------------------------------------------------------
...
-- `plugins.treesitter` does not set 'indentexpr' for Julia buffers, so that this wrapper
-- is not overridden.
vim.bo.indentexpr = julia_indent
